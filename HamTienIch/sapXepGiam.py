...
def sapXep(file_name, column_name, ascending=False, output_file=None):
...
def sapXepGiam():
    ...
    if n == 1:
        sapXep(file_name, 'Temperature (°C)', ascending=False, output_file=output_file)
    elif n == 2:
        sapXep(file_name, 'Humidity (%)', ascending=False, output_file=output_file)
    elif n == 3: 
        sapXep(file_name, 'Wind Speed (mph)', ascending=False, output_file=output_file)
    elif n == 4: 
        sapXep(file_name, 'Precipitation (%)', ascending=False, output_file=output_file)
    elif n == 5: 
        sapXep(file_name, 'Atmospheric Pressure (hPa)', ascending=False, output_file=output_file)
    elif n == 6: 
        sapXep(file_name, 'UV Index', ascending=False, output_file=output_file)
    elif n == 7:
        sapXep(file_name, 'Visibility (km)', ascending=False, output_file=output_file)
